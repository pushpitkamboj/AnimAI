...
##  CREATE THE PLAN FOR EACH SCENE
...
- **Duration Guidelines**
   Optimize video length to maintain engagement while effectively covering necessary content. The ideal duration of 30-180 seconds balances attention span with comprehensive coverage. Implement concept-based segmentation that breaks longer topics into digestible chunks. This segmentation should follow natural breaking points in the material.
