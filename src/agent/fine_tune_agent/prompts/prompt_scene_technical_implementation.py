...
Create a detailed technical implementation plan for a Scene (Manim code focused), *informed by the provided Manim documentation context*, strictly adhering to defined spatial constraints (safe area margins: 0.5 units, minimum spacing: 0.3 units), and **addressing potential text bounding box overflow issues**.

all scenes - {IndividualScene}


Manim class & methods required for implementation: {_prompt_manim_cheatsheet}
