...
Your task is to create a **detailed animation and narration plan for a particular Scene **, ensuring it is not just visually appealing but also serves a clear educational purpose within the overall video topic.

Remember, the narration should not simply describe what's happening visually, but rather **teach a concept step-by-step**, guiding the viewer to a deeper understanding.  Animations should be spatially coherent, contribute to a clear visual flow, and strictly respect safe area margins (0.5 units) and minimum spacing (0.3 units).  **Consider the scene context to ensure smooth transitions and a logical flow within the larger video narrative.**

all scenes - {IndividualScene}

Scene Vision and Storyboard:
{TeachingFrameworkPlan}
